...
% Opensky and urban data format: 8-bit I/Q samples
...
% Opensky data file -------------------------------------------------------
% settings.fileName                = ['D:\University\PhD program\Subjects\' ...
%     'Satellite Communication and Navigation\Assignment_1\Opensky.bin'];
% Urban data file ---------------------------------------------------------
settings.fileName                = ['D:\University\PhD program\Subjects\' ...
    'Satellite Communication and Navigation\Assignment_1\Urban.dat'];

% Intermediate and sampling frequencies Opensky
% settings.IF                      = -1580e6+1575.42e6;   % [Hz]
% settings.samplingFreq            = 58e6;                % [Hz]

% Intermediate and sampling frequencies Urban
settings.IF                      = 0;             % [Hz]
...
settings.navSolPeriod            = 500;          % [ms] 500 @@@@
