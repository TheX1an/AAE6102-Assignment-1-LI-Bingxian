...
if ((settings.skipAcquisition == 0) || ~exist('acqResults', 'var'))
    ...
    save("Task_1_acquisition","acqResults")
end
...
%% Track the signal =======================================================
if ~exist("Task_2_tracking.mat")
startTime = now;
disp (['   Tracking started at ', datestr(startTime)]);

% Process all channels for given data block
[trkResults, ~] = tracking(fid, channel, settings);
save("Task_2_tracking","trkResults")
...
disp(['   Tracking is over (elapsed time ', ...
    ...
    load("Task_2_tracking.mat");
end                     

%% Calculate navigation solutions =========================================
disp('   Calculating navigation solutions...');

[navResults, dcdResults] = postNavigation(trkResults, acqResults, settings);
save("Task_3_navigation_data_decoding","dcdResults")
save("Task_4_5_position_and_velocity_estimation","navResults")
