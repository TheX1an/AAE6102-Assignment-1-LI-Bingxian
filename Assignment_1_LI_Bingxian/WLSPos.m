function [pos,el, az, dop, Amatrix] = WLSPos(satpos,obs,CNo,settings)
%Function calculates the Least Square Solution.
% based on pseudorange measurements weighted by C/N0.
%
%
...
%       CNo     - Carrier-to-Noise density ratio for weighting
...
% Convert C/N0 to weights (higher C/N0 -> higher weight)
weights = 10.^(CNo / 10);  % Convert dB-Hz to linear scale
...
for iter = 1:nmbOfIterations
    ...
    % WLS solution: x = (A' W A)^(-1) A' W omc
